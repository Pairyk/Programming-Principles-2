...
get_contacts_by_name = "SELECT * FROM phonebook WHERE user_name LIKE %s;"
get_contacts_by_number = "SELECT * FROM phonebook WHERE phone_number LIKE %s;"

updating_contacts_by_number = """
UPDATE phonebook
SET user_name = %s
WHERE phone_number = %s;
"""

updating_contacts_by_name = """
UPDATE phonebook
SET phone_number = %s
WHERE user_name = %s;
"""
...
deleting_contacts_all = "DELETE FROM phonebook"